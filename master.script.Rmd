...
DefaultAssay(hbca.integrated)<-"integrated"
hci001.anchors <- FindTransferAnchors(reference = hbca.integrated, query = hci001.query, 
    dims = 1:30)
predictions <- TransferData(anchorset = hci001.anchors, refdata = hbca.integrated$coarse.ident, 
    dims = 1:30)
hci001.query <- AddMetaData(hci001.query, metadata = predictions)

hci002.query <- p02.counts
DefaultAssay(hbca.integrated)<-"integrated"
hci002.anchors <- FindTransferAnchors(reference = hbca.integrated, query = hci002.query, 
    dims = 1:30)
predictions <- TransferData(anchorset = hci002.anchors, refdata = hbca.integrated$coarse.ident, 
    dims = 1:30)
hci002.query <- AddMetaData(hci002.query, metadata = predictions)

hci010.query <- p10.counts
DefaultAssay(hbca.integrated)<-"integrated"
hci010.anchors <- FindTransferAnchors(reference = hbca.integrated, query = hci010.query, 
    dims = 1:30)
predictions <- TransferData(anchorset = hci010.anchors, refdata = hbca.integrated$coarse.ident, 
    dims = 1:30)
